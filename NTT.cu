...
//void ntt_64K(uint64_t* Y,uint64_t* X,uint32_t* x,uint64_t* root,uint64_t* root_64K)
//{ 
//	dim3 BlockDim(16,16);
//	NTT_Kernel_64K_points_1<<<16,BlockDim>>>(X,x,root);
//	NTT_Kernel_64K_points_2<<<16,BlockDim>>>(Y,X,root,root_64K);
//}
void intt_64K(uint64_t* Y,uint64_t* X,uint64_t* x,uint64_t* root,uint64_t* root_64K)
{
	dim3 BlockDim(16,16);
	INTT_Kernel_64K_points_1<<<16,BlockDim>>>(X,x,root);
	INTT_Kernel_64K_points_2<<<16,BlockDim>>>(Y,X,root,root_64K);
}
...
{
	if (length == 16384) {
		ntt_1_16k_ext<<<length/512, 64, 0, st>>>(ptrNttSwap(dev), x);
		//CCE();
		ntt_2_16k<<<length/512, 64, 0, st>>>(ptrNttSwap(dev));
		//CCE();
		ntt_3_16k<<<length/512, 64, 0, st>>>(X, ptrNttSwap(dev));
		//CCE();
	}
	else if (length == 32768) {
		ntt_1_32k_ext<<<length/512, 64, 0, st>>>(ptrNttSwap(dev), x);
		//CCE();
		ntt_2_32k<<<length/512, 64, 0, st>>>(ptrNttSwap(dev));
		//CCE();
		ntt_3_32k<<<length/512, 64, 0, st>>>(X, ptrNttSwap(dev));
		//CCE();
	}
	else if (length == 65536) {
		ntt_1_64k_ext<<<length/512, 64, 0, st>>>(ptrNttSwap(dev), x);
		//CCE();

		ntt_2_64k<<<length/512, 64, 0, st>>>(ptrNttSwap(dev));
		//CCE();

		ntt_3_64k<<<length/512, 64, 0, st>>>(X, ptrNttSwap(dev));
		//CCE();
